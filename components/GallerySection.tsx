...
// Đã bổ sung nội dung cho HLS6 và HLS7
const imageData = [
  { src: "/anhHLS1.jpg", title: "Cầu Rồng Đà Nẵng", desc: "Biểu tượng phun lửa về đêm" },
  { src: "/HLS2.jpg", title: "Bà Nà Hills", desc: "Lâu đài giữa mây trời" },
  { src: "/HLS3.jpg", title: "Đà Nẵng Downtown", desc: "Ngắm nhìn toàn thành phố" },
  { src: "/HLS4.jpg", title: "Bãi đá Sơn Trà", desc: "Thiên đường biển xanh cát trắng" },
  { src: "/HLS5.jpg", title: "Phố cổ Hội An", desc: "Lồng đèn rực rỡ bên sông Hoài" },
  { src: "/HLS6.jpg", title: "Ngũ Hành Sơn", desc: "“Nam Thiên Danh Thắng” trứ danh" },
  { src: "/HLS7.jpg", title: "Thánh địa Mỹ Sơn", desc: "Vùng đất của những điều bí ẩn" },
];
...
const GallerySection = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-amber-50/20 via-white to-amber-50/10 py-16">
